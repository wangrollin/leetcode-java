package com.wangrollin.leetcode.n0_normal.p800.p810.problem811;
...
public class Solution1 {
    ...
    public List<String> subdomainVisits(String[] cpdomains) {
        ...
        Arrays.stream(cpdomains).forEach(str -> {
            ...
            while (true) {
                ...
                result.put(domain, result.getOrDefault(domain, 0) + num);
        ...
        result.entrySet().stream().forEach(entry -> finalResult.add(entry.getValue() + " " + entry.getKey()));
        return finalResult;
    }
}
